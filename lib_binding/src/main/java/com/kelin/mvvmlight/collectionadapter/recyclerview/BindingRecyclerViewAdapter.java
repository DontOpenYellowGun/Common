...
public class BindingRecyclerViewAdapter<T> extends RecyclerView.Adapter<ViewHolder> implements BindingCollectionAdapter<T> {
    ...
    public final void onBindViewHolder(ViewHolder viewHolder, int position) {
        ...
        if (onItemChildClickListener != null) {
            onItemChildClickListener.convert(position, viewHolder.itemView);
        }
    }
...
//   暂时注释掉    因为有冲突   如果在itemModel里面设置clickCommand ,并且是在Item的根布局设置的，就会导致这里设置的listener覆盖掉itemModel里面的
        //clickCommand
...
//
    ...
    public BindingRecyclerViewAdapter.onItemClickListener getOnItemClickListener() {
        return onItemClickListener;
    }

    public void setOnItemClickListener(BindingRecyclerViewAdapter.onItemClickListener onItemClickListener) {
