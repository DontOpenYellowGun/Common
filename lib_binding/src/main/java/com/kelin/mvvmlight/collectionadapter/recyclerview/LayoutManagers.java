...
public class LayoutManagers {
     ...
     * A {@link LinearLayoutManager}.
     */
    public static LayoutManagerFactory linear(final boolean canScroll) {
        return new LayoutManagerFactory() {
            @Override
            public RecyclerView.LayoutManager create(RecyclerView recyclerView) {
                return new LinearLayoutManager(recyclerView.getContext()) {
     ...
     * A {@link LinearLayoutManager}.
     */
    public static LayoutManagerFactory grid(final int spanCount, final boolean canScrollVertical) {
        return new LayoutManagerFactory() {
            @Override
            public RecyclerView.LayoutManager create(RecyclerView recyclerView) {
                return new GridLayoutManager(recyclerView.getContext(), spanCount) {
     ...
     * A {@link LinearLayoutManager}.
     */
    public static LayoutManagerFactory grid(final int spanCount, final boolean canScrollVertical, final boolean canScrollHorizontal) {
        return new LayoutManagerFactory() {
            @Override
            public RecyclerView.LayoutManager create(RecyclerView recyclerView) {
                return new GridLayoutManager(recyclerView.getContext(), spanCount) {
