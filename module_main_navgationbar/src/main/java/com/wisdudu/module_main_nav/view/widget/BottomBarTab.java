package com.wisdudu.module_main_nav.view.widget;
...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(ContextCompat.getColor(context, R.color.main_nav_tab_unselect));
        ...
        mTvTitle.setTextColor(ContextCompat.getColor(context, R.color.main_nav_tab_unselect));
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            ...
            mIcon.setColorFilter(ContextCompat.getColor(mContext, R.color.main_nav_tab_unselect));
            mTvTitle.setTextColor(ContextCompat.getColor(mContext, R.color.main_nav_tab_unselect));
        }
    }
